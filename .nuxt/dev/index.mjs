globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://D:/project/blog/node_modules/.pnpm/node-fetch-native@1.1.1/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://D:/project/blog/node_modules/.pnpm/std-env@3.3.3/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getQuery as getQuery$1, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file://D:/project/blog/node_modules/.pnpm/h3@1.6.6/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://D:/project/blog/node_modules/.pnpm/vue-bundle-renderer@1.0.3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/project/blog/node_modules/.pnpm/devalue@4.3.2/node_modules/devalue/index.js';
import { renderToString } from 'file://D:/project/blog/node_modules/.pnpm/vue@3.3.4/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://D:/project/blog/node_modules/.pnpm/ofetch@1.0.1/node_modules/ofetch/dist/node.mjs';
import destr from 'file://D:/project/blog/node_modules/.pnpm/destr@1.2.2/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://D:/project/blog/node_modules/.pnpm/unenv@1.5.1/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/project/blog/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file://D:/project/blog/node_modules/.pnpm/scule@1.0.0/node_modules/scule/dist/index.mjs';
import { klona } from 'file://D:/project/blog/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/project/blog/node_modules/.pnpm/defu@6.1.2/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://D:/project/blog/node_modules/.pnpm/ohash@1.1.2/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file://D:/project/blog/node_modules/.pnpm/ufo@1.1.2/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/project/blog/node_modules/.pnpm/unstorage@1.6.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/project/blog/node_modules/.pnpm/unstorage@1.6.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/project/blog/node_modules/.pnpm/radix3@1.0.1/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file://D:/project/blog/node_modules/.pnpm/pathe@1.1.0/node_modules/pathe/dist/index.mjs';
import { unified } from 'file://D:/project/blog/node_modules/.pnpm/unified@10.1.2/node_modules/unified/index.js';
import { toString } from 'file://D:/project/blog/node_modules/.pnpm/mdast-util-to-string@3.2.0/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file://D:/project/blog/node_modules/.pnpm/micromark@3.1.0/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file://D:/project/blog/node_modules/.pnpm/micromark@3.1.0/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file://D:/project/blog/node_modules/.pnpm/unist-util-stringify-position@3.0.3/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file://D:/project/blog/node_modules/.pnpm/micromark-util-character@1.1.0/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file://D:/project/blog/node_modules/.pnpm/micromark-util-chunked@1.0.0/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file://D:/project/blog/node_modules/.pnpm/micromark-util-resolve-all@1.0.0/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file://D:/project/blog/node_modules/.pnpm/remark-emoji@3.1.1/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file://D:/project/blog/node_modules/.pnpm/rehype-slug@5.1.0/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file://D:/project/blog/node_modules/.pnpm/remark-squeeze-paragraphs@5.0.1/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file://D:/project/blog/node_modules/.pnpm/rehype-external-links@2.1.0/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file://D:/project/blog/node_modules/.pnpm/remark-gfm@3.0.1/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file://D:/project/blog/node_modules/.pnpm/rehype-sort-attribute-values@4.0.0/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file://D:/project/blog/node_modules/.pnpm/rehype-sort-attributes@4.0.0/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file://D:/project/blog/node_modules/.pnpm/rehype-raw@6.1.1/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file://D:/project/blog/node_modules/.pnpm/remark-mdc@1.1.3/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file://D:/project/blog/node_modules/.pnpm/remark-parse@10.0.2/node_modules/remark-parse/index.js';
import remark2rehype from 'file://D:/project/blog/node_modules/.pnpm/remark-rehype@10.1.0/node_modules/remark-rehype/index.js';
import { all } from 'file://D:/project/blog/node_modules/.pnpm/mdast-util-to-hast@12.3.0/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file://D:/project/blog/node_modules/.pnpm/detab@3.0.2/node_modules/detab/index.js';
import { u } from 'file://D:/project/blog/node_modules/.pnpm/unist-builder@3.0.1/node_modules/unist-builder/index.js';
import { encode } from 'file://D:/project/blog/node_modules/.pnpm/mdurl@1.0.1/node_modules/mdurl/index.js';
import slugify from 'file://D:/project/blog/node_modules/.pnpm/slugify@1.6.6/node_modules/slugify/slugify.js';
import { position } from 'file://D:/project/blog/node_modules/.pnpm/unist-util-position@4.0.4/node_modules/unist-util-position/index.js';
import { visit } from 'file://D:/project/blog/node_modules/.pnpm/unist-util-visit@4.1.2/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file://D:/project/blog/node_modules/.pnpm/shiki-es@0.2.0/node_modules/shiki-es/dist/shiki.node.mjs';
import { consola } from 'file://D:/project/blog/node_modules/.pnpm/unenv@1.5.1/node_modules/unenv/runtime/npm/consola.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/project/blog/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"D:\\project\\blog\\content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\project\\blog\\.nuxt\\content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\project\\blog","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\project\\blog\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\project\\blog\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\project\\blog\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _MuzbqrBXFH = (function(nitro) {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://D:/project/blog/node_modules/.pnpm/json5@2.2.3/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _YTvykr = defineEventHandler(async (event) => {
...
const _A3Lb9Y = defineEventHandler(async (event) => {
...
const _NJrnyi = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_696rxo = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_696rxo, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _YTvykr, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _YTvykr, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _YTvykr, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _A3Lb9Y, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _NJrnyi, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _NJrnyi, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _NJrnyi, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_696rxo, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/project/blog/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://D:/project/blog/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
